...
class _ContactPageState extends State<ContactPage> {
  ...
  Color _currentColor = Colors.purple; // Ganti warna default
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        backgroundColor: Colors.deepPurple[900], // Ganti warna appbar
        centerTitle: true,
        actions: [
          IconButton(
          ...
          children: [
            UserAccountsDrawerHeader(
              decoration: BoxDecoration(
                color: Colors.deepPurple[900], // Ganti warna drawer header
              ),
              accountName: Text(
              ...
              currentAccountPicture: CircleAvatar(
                backgroundColor:
                    Colors.deepPurple, // Ganti warna avatar sesuai keinginan
                child: Icon(
                  Icons.person,
                  size: 48,
                  color: Colors.white,
